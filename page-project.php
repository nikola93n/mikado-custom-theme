                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="img-container px-4 pt-4"><img class="img-fluid"
                                    src="<?php echo $related_project_one_image['url']; ?>" alt=""></div>
                            ...
                            <a
                                href="<?php $related_project_one_url; ?>"><?php echo $related_project_one_link_text; ?></a>
                        </div>
                        <?php endif; ?>
                        <div class="swiper-slide">
                            <div class="img-container px-4 pt-4"><img class="img-fluid"
                                    src="images/projects/related-projects-2.jpg" alt=""></div>
                            <h5>Name of the Project</h5>
                            <a href="#">Read More</a>
                        </div>
                        <div class="swiper-slide">
                            <div class="img-container px-4 pt-4"><img class="img-fluid"
                                    src="images/projects/related-projects-3.jpg" alt=""></div>
                            <h5>Name of the Project</h5>
                            <a href="#">Read More</a>
                        </div>
                        <div class="swiper-slide">
                            <div class="img-container px-4 pt-4"><img class="img-fluid"
                                    src="images/projects/related-projects-4.jpg" alt=""></div>
                            <h5>Name of the Project</h5>
                            <a href="#">Read More</a>
                        </div>
                    </div>
